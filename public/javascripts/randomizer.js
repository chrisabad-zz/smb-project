$(function() {
	...
	analytics.track("Company page presented", {product: shuffledConcepts[0].product_name})
	analytics.track("Company page presented", {product: shuffledConcepts[1].product_name})
	analytics.track("Company page presented", {product: shuffledConcepts[2].product_name})
